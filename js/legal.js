// ============================================
// TV Tracker - Legal Modals & Feedback
// ============================================
    ...
    modal.innerHTML = `
      <div class="modal legal-modal">
        ...
        <div class="legal-body">
          <p>Submit your ${formType.toLowerCase()} below. Thank you for helping us make TV Tracker even better!</p>
          <form id="webhookForm" onsubmit="handleFeedbackSubmit(event, '${formType}')">
...
function handleFeedbackSubmit(e, formType) {
  e.preventDefault();
  ...
  setTimeout(() => {
    ...
    setTimeout(() => closeLegalModal(), 1200);
  }, 400);
}
